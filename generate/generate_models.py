# TODO: Validate
"""Rebuilds every JustScrape model from the responses recorded under `_files`.
...
# TODO: Validate
def generate_all(client: JustScrape) -> None:
...
if __name__ == "__main__":
    ...
    generate_all(JustScrape(build_client_automatically()))
