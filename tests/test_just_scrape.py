...
class TestParsing:
    ...
    def test_get_new_titles(self) -> None:
        for json_file in self.get_test_files("get_new_titles"):
            file_content = json.loads(json_file.read_text())
            parsed = client.parse_get_new_titles(file_content)
            dumped = parsed.model_dump(mode="json", by_alias=True, exclude_unset=True)
            assert file_content == dumped
    ...
    def test_get_new_title_buckets(self) -> None:
        for json_file in self.get_test_files("get_new_title_buckets"):
            file_content = json.loads(json_file.read_text())
            parsed = client.parse_get_new_title_buckets(file_content)
            dumped = parsed.model_dump(mode="json", by_alias=True, exclude_unset=True)
            assert file_content == dumped
    ...
    def test_get_url_title_details(self) -> None:
        for json_file in self.get_test_files("get_url_title_details"):
            file_content = json.loads(json_file.read_text())
            parsed = client.parse_get_url_title_details(file_content)
            dumped = parsed.model_dump(mode="json", by_alias=True, exclude_unset=True)
            assert file_content == dumped
    ...
    def test_get_season_episodes(self) -> None:
        for json_file in self.get_test_files("get_season_episodes"):
            file_content = json.loads(json_file.read_text())
            parsed = client.parse_get_season_episodes(file_content)
            dumped = parsed.model_dump(mode="json", by_alias=True, exclude_unset=True)
            assert file_content == dumped
...
class TestGetAll:
    def test_get_all_new_titles_for_date(self) -> None:
        ...
        for i in range(1, 10):
            ...
            # are required.
            all_edges = client.get_all_new_titles_get_edges(all_new_titles_for_date)
    ...
    def test_get_all_new_titles_since_date(self) -> None:
        ...
        actual_edges = len(client.get_all_new_titles_get_edges(responseses))
    ...
    def test_get_all_season_episodes(self) -> None:
        ...
        episodes = client.get_all_season_episodes_get_episodes(season_episodes)
