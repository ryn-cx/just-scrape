...
class Content(BaseModel):
    ...
    original_release_date: str = Field(..., alias="originalReleaseDate")
...
class Title(BaseModel):
    ...
    poster_url: str = Field(..., alias="posterUrl")
    title: str
    show_title: str | None = Field(..., alias="showTitle")
...
class Node2(BaseModel):
    ...
    field__typename: str = Field(..., alias="__typename")
    seen_state: SeenState1 | None = Field(None, alias="seenState")
...
class Credit1(BaseModel):
    ...
    character_name: str = Field(..., alias="characterName")
    person_id: int = Field(..., alias="personId")
    portrait_url: None = Field(..., alias="portraitUrl")
    profile_path: None = Field(..., alias="profilePath")
    field__typename: str = Field(..., alias="__typename")
...
class Show2(BaseModel):
    ...
    object_id: int = Field(..., alias="objectId")
    object_type: str = Field(..., alias="objectType")
    total_season_count: int = Field(..., alias="totalSeasonCount")
    customlist_entries: list = Field(..., alias="customlistEntries")
    tv_show_tracking_entry: None = Field(..., alias="tvShowTrackingEntry")
    fall_back_clips: FallBackClips2 = Field(..., alias="fallBackClips")
    content: Content9
    seen_state: SeenState2 = Field(..., alias="seenState")
    watchlist_entry_v2: None = Field(..., alias="watchlistEntryV2")
...
class Node(BaseModel):
    ...
    dislikelist_entry: None = Field(..., alias="dislikelistEntry")
    watchlist_entry_v2: None = Field(None, alias="watchlistEntryV2")
    customlist_entries: list | None = Field(None, alias="customlistEntries")
