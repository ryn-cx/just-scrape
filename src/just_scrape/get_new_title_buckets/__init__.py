...
class GetNewTitleBuckets(JustWatchProtocol):
    def _variables_get_new_title_buckets(  # noqa: PLR0913
        self,
        *,
        first: int = 8,
        bucket_size: int = 0,
    ...
    def _download_get_new_title_buckets(  # noqa: PLR0913
        self,
        *,
        first: int = 8,
        bucket_size: int = 0,
        ...
        variables = self._variables_get_new_title_buckets(
            first=first,
    ...
    def parse_get_new_title_buckets(self, response: dict[str, Any]) -> Model:
    ...
    def get_new_title_buckets(  # noqa: PLR0913
        ...
        *,
        ...
        response = self._download_get_new_title_buckets(
            first=first,
            bucket_size=bucket_size,
            group_by=group_by,
            page_type=page_type,
        ...
        return self.parse_get_new_title_buckets(response)
